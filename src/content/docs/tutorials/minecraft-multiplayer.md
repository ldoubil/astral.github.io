...
1.[电脑端安装MC联机模组](#电脑安装MC联机模组)

2.[手机端安装MC联机模组](#手机安装MC联机模组)
...
> ⚠️ **重要提醒：** 没有“推荐的模组版本”看[这里](#找不到推荐的模组版本)
...
1. **打开右下角“管理版本”，随后便可看到游戏版本和对应的模组加载器**
...
**进阶优化：** [进阶配置教程](#进阶配置教程（关于KCP和QUIC代理）)
