...
**Step 1：**进入FCL启动器，点击左侧的下载，在弹出的页面中选择模组
...
**Step 3：** 点击**Lan Server Properties**模组
...
**Step 1：** 房间页面 → 右下角任务板图标 → 输入房主提供的分享码
...
**Step 1：** 点击左侧菜单栏"服务器" → 右下角地球图标，选择在最上方的1-3个延迟低的服务器，并点击添加

![服务器选择](/images/MC联机/MC联机-64.png)

**Step 2：** 记得不要忘记在服务器页面启用您选择的服务器
...
**Step 1：** 设置 → 全局游戏设置 → "渲染器设置"

![渲染器设置](/images/MC联机/MC联机-35.png)

**Step 2：** 选择 MobileGlues 渲染器，该渲染器需要另外手动安装
...
- 简化格式：`10.0.0.2`（端口 25565 时可省略）
 ⚠️ **重要前提：** 该地址为示例地址，请以软件房间页面中的地址为准
...
**Step 1：** 点击左边"服务器" → 在如下图所示的红色位置

![丢包率演示](/images/MC联机/MC联机-43.png)

> ⚠️ **重要前提：** 您不仅仅需要看房员的丢包情况，还需要留意服务器的丢包情况
...
> ⚠️ **重要前提：** 如果两个同时开启，则默认使用KCP代理，如果您需要使用QUIC代理，请关闭“启用KCP代理”，并打开“启用QUIC代理”
